...
public class CreateTakeAwayOrder extends WebBase {
	...
	private By ItemName = By.xpath("//div[contains(@class, 'dish-text') and normalize-space(text())='fffff']\n"
			+ "");
	...
	private By nextButton = By.xpath("//button[contains(@class, 'save')]\n"
			+ "");
    ...
    private By CompleteTakeAwayOrer = By.xpath("//app-order-right//button[span[normalize-space(text())='COMPLETE ORDER']]\n"
    		+ "");
	...
	private By RevertOrderButton = By.xpath("//app-order-right//button[span[normalize-space(text())='Revert Order']]\n"
			+ "");
	...
	public void CreateOrderButton() throws InterruptedException {
		...
		clickOnElement(CreateOrderButton, "Clicked on Create Order for Take Away Order Type", 10);
		//Thread.sleep(3000);
	}
