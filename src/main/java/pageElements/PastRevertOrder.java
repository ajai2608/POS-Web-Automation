...
private By SettleButtonDashboard = By.xpath ("//app-order-right//button[span[normalize-space(text())='SETTLE BILL']]\n"
		+ ""); 
...
private By CompleteOrder = By.xpath("//button[span[normalize-space(text())='COMPLETE ORDER']]\n"
		+ "");
private By ClickOnPast = By.xpath("/html/body/app-root/body/div/div/div[2]/app-order/div/div[1]/nz-tabset/nz-tabs-nav/div/div/div[2]/div");
