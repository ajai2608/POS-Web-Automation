...
private By RunningOrderDashboardPrintButton = By.xpath ("//button[span[text()=' PRINT ']]\n"
		+ "");
...
private By PastprintButton = By.xpath("//button[contains(@class, 'success_button') and contains(@class, 'ant-btn-lg')]\n"
		+ "");
...
private By closemergepop = By.xpath("/html/body/div[1]/div[3]/div/mat-dialog-container/div/div/app-order-details/div[1]/div[1]/div[2]/img");
