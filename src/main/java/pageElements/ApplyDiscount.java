...
public class ApplyDiscount extends WebBase {
	...
	private By AddAmountLink = By.cssSelector("div.cart-body > div.ng-star-inserted > div > p.fs-16.fb.discount.c-pointer.ng-star-inserted\n"
			+ "");
										//html/body/app-root/body/div/div/div/app-pos-order/section/div/app-cart/div/div[2]/div[3]/div[8]/p[2]
	private By FlatDiscount = By.xpath("/html/body/div[1]/div[3]/div/mat-dialog-container/div/div/app-add-discount/div/nz-tabset/nz-tabs-nav/div/div/div[2]/div");
